...
function Header() {
  return (
    <Container className="mt-16">
      <Heading as="h1">Empowering teams to achieve more.</Heading>
      <Lead className="mt-6 max-w-3xl">
        We’re on a mission to revolutionize how teams collaborate and manage
        projects, leveraging powerful tools and insights.
      </Lead>
      <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
        <div className="max-w-lg">
          <h2 className="text-2xl font-medium tracking-tight">Our mission</h2>
          <p className="mt-6 text-sm/6 text-gray-600">
            At Kinetic, we are dedicated to streamlining project management and
            team collaboration. Our mission is to empower organizations to work
            smarter and more efficiently, ensuring that no task is overlooked
            and every project moves forward with precision.
          </p>
          <p className="mt-8 text-sm/6 text-gray-600">
            We’re customer-focused—committed to building tools that enhance
            productivity, communication, and accountability. At Kinetic, we
            believe in the power of teamwork and strive to provide our users
            with the features they need to excel, from task tracking to
            real-time collaboration and beyond.
          </p>
        </div>
        ...
        <div className="max-lg:mt-16 lg:col-span-1">
          ...
          <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-gray-200 max-sm:pb-4">
              ...
              <dd className="order-first text-6xl font-medium tracking-tight">
                <AnimatedNumber start={60} end={80} decimals={1} />K
              </dd>
            </div>
            <div className="flex flex-col gap-y-2">
              <dt className="text-sm/6 text-gray-600">Tasks Started</dt>
              <dd className="order-first text-6xl font-medium tracking-tight">
...
function Team() {
  return (
    <Container className="my-32">
      <Subheading>Meet the Creator</Subheading>
      <Heading as="h3" className="mt-2">
        Built by an aspiring front-end developer.
      </Heading>
      <Lead className="mt-6 max-w-3xl">
        Kinetic was created by Tom Carruthers, a hopeful front-end developer who
        thought, "Hey, maybe if I build something that looks like a real
        product, someone might actually hire me."
      </Lead>
      <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
        <div className="max-w-lg">
          <p className="text-sm/6 text-gray-600">
            It was brought to life by Tom Carruthers, a front-end developer with
            a vision (and, let’s be honest, a serious passion for project
            management tools). He wanted to make something that could impress
            employers while tackling the age-old problem of task and project
            management with a fresh approach.
          </p>
          <p className="mt-8 text-sm/6 text-gray-600">
            Tom used to work in mechanical engineering but recently made the
            leap into software development. He wanted to combine his technical
            skills with a knack for keeping things organized, and so Kinetic was
            born. With this project, Tom hopes to show off what he can do and
            land that dream role in front-end development.
          </p>
          <div className="mt-6">
            <Button
