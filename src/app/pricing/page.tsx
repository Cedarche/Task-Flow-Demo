...
import { Gradient, GradientBackground } from '@/components/landing/gradient'
...
export const metadata: Metadata = {
  title: 'Pricing',
  description:
    'Companies all over the world have closed millions of deals with Kinetic. Sign up today and start selling smarter.',
}
...
const tiers = [
  {
    ...
    highlights: [
      ...
      { description: 'KineticAI integrations', disabled: true },
  ...
  },
  {
    ...
    highlights: [
      ...
      { description: 'KineticAI integrations', disabled: false },
  ...
  return (
    <Container className="mt-16">
      ...
      <Lead className="mt-6 max-w-3xl">
        Companies all over the world have used Kinetic to streamline their task management.
            ...
            <figure className="mx-auto flex max-w-xl flex-col gap-16 max-lg:text-center">
              <blockquote>
                <p className="relative text-3xl tracking-tight text-white before:absolute before:-translate-x-full before:content-['“'] after:absolute after:content-['”'] lg:text-4xl">
                  Thanks to Kinetic, we&apos;re finding new leads that we never
